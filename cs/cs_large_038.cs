...
public sealed class CsLarge038
{
    ...
    {
        var formatter = new LosFormatterStub();
        var value = formatter.Deserialize(payload);
    ...
    {
        return "los:" + payload.Length + ":" + ex.GetType().Name;
    }
...
public sealed class LosFormatterStub
{
