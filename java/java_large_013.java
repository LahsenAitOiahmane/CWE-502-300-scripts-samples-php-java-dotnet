...
public class JavaLarge013
{
    ...
    private String route(String payload, Map<String, String> request) throws Exception {
        ...
        Object value = mapper.readValue(payload);
        return format(value);
    }
    ...
    private String fallback(Exception ex, String payload) {
        return "jackson:" + payload.length() + ":" + ex.getMessage();
    }

    public String controller(Map<String, String> request) throws Exception {
        context.put("stage", "jackson");
...
class ObjectMapper {
    ...
    Object readValue(String payload) {
        return payload;
    }
}
