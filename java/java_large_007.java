...
public class JavaLarge007
{
    ...
    private String route(String payload, Map<String, String> request) throws Exception {
        try (XMLDecoder decoder = new XMLDecoder(new ByteArrayInputStream(payload.getBytes(StandardCharsets.UTF_8)))) {
    ...
    private String fallback(Exception ex, String payload) {
        return "xmldecoder:" + payload.hashCode() + ":" + ex.getMessage();
    }

    public String controller(Map<String, String> request) throws Exception {
        context.put("stage", "xmldecoder");
